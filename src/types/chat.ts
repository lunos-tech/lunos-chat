...
// ─── Generated (model output) images ─────────────────────────────────

export interface GeneratedImage {
  id: string;
  /** Raw URL as returned by the API. Usually a data URL (data:image/...;base64,...) or remote https URL. */
  url: string;
  /** Optional MIME hint derived from the data URL prefix. */
  mime?: string;
}

/** Optional per-request image output configuration. */
...
export interface ChatMessage {
  ...
  /** Images generated by the model (from `message.images` / `delta.images`). */
