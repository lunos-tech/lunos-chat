        ...
        <div className="border-t border-border px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a href="https://github.com/lunos-tech/lunos-chat" target="_blank" rel="noopener noreferrer" className="rounded p-1.5 text-muted-foreground transition-colors hover:bg-surface-2 hover:text-foreground">
                    <Github size={14} />
                  </a>
                </TooltipTrigger>
                <TooltipContent>
